...
double fact(double),pow(double,double),degreestorad(double),Mycos(double);     // prototyping 
int inputdata(int);
...
double Mycos(double x)		//υπολογισμός συνημίτονου
{
	int p,sign;
	double sum,term,l;
	p=2;
